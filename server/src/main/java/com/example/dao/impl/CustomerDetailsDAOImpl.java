...
public class CustomerDetailsDAOImpl implements CustomerDetailsDAO {
	...
	public CustomerDetailsDAOImpl() {
		...
		CustomerDetails customerDetails1 = new CustomerDetails(1, "Manish Shaw", "abc@test.com", "1356842612",
				"Bangalore", "Karnataka", "India", "Company1", "Developer", "Very interested in the products");
		CustomerDetails customerDetails2 = new CustomerDetails(2, "Name2", "abcd@test.com", "37843784634",
				"Mangalore", "Karnataka", "India", "Company2", "Analyst", "Very interested in the products but buys rarely");
		CustomerDetails customerDetails3 = new CustomerDetails(3, "Name3", "abcde@test.com", "6786877898",
